export function DiscoverCardSkeleton() {
  return (
    <div className='swiper-item relative flex h-full w-full shrink-0 items-end justify-start overflow-hidden p-4 py-20 pb-(--discover-space) sm:px-12'>
      ...
      <div className='absolute inset-0 z-0 h-120 min-h-120 w-full animate-pulse bg-gray-700 object-cover sm:h-svh' />
      ...
      <div className='z-20 flex w-5/6 flex-col gap-2 tracking-wide md:w-[45%] md:gap-4'>
        ...
        <div className='mt-2 flex gap-2'>
          <div className='h-9 w-28 animate-pulse rounded-full bg-gray-600 sm:h-11 sm:w-40 sm:rounded-lg' />
          <div className='h-9 w-28 animate-pulse rounded-full bg-gray-600 sm:h-11 sm:w-40 sm:rounded-lg' />
        </div>
      </div>
    </div>
