...
export function DiscoverCard(props: Props) {
  ...
  return (
    <div className='swiper-item relative flex h-full w-full shrink-0 items-end justify-start overflow-hidden p-4 py-20 pb-(--discover-space) sm:px-12'>
      <img
        height='1280'
        width='720'
        alt={title}
        ...
        loading='eager'
        className='absolute inset-0 z-0 h-120 min-h-120 w-full object-cover sm:h-svh'
      />
      ...
      <div className='z-20 flex w-5/6 flex-col gap-2 tracking-wide md:w-[45%] md:gap-4'>
        <div className='flex flex-col gap-1 md:gap-2'>
          <h2 className='line-clamp-2 shrink-0 py-1 text-2xl leading-tight font-semibold text-white sm:text-4xl'>
            {title}
          </h2>
        ...
        <div className='mt-2 flex gap-2'>
          <a
            className='flex w-28 shrink-0 items-center justify-center gap-1 overflow-hidden rounded-full bg-primary-500 p-2 text-sm font-semibold text-black hover:brightness-[.8] sm:w-40 sm:rounded-lg sm:py-[.65rem] sm:text-base'
          ...
          <a
            className='flex w-28 items-center justify-center gap-1 overflow-hidden rounded-full bg-[#e6e5eb33] p-2 text-sm font-medium tracking-wide text-[whitesmoke] hover:bg-white/10 sm:w-40 sm:rounded-lg sm:py-[.65rem] sm:text-base'
